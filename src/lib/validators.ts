...
export const createEventSchema = z.object({
  ...
  templateId: z.enum(["elegant-dark", "floral-light", "minimal-white", "rustic-kraft", "modern-gradient", "julia-xv", "noche-dorada", "camila-glam", "bautismo-tierno", "gala-corporativa", "canva-boho"]).default("elegant-dark"),
