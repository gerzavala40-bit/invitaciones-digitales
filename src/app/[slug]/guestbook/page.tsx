  ...
  return (
    <main className="min-h-screen py-12 px-4" style={{ fontFamily: "var(--font-sans)", background: "linear-gradient(to bottom, #F0F6FA 0%, #C1DFF0 100%)", color: "#5A6B7C" }}>
      <style>{`
        ...
        .clara-guestbook button[type="submit"] { background: linear-gradient(135deg, #C4A661, #D4AF37) !important; color: #ffffff !important; border-radius: 999px !important; text-transform: uppercase; font-size: 0.72rem; letter-spacing: 0.16em; font-weight: 600; padding: 1rem 1.75rem !important; }
